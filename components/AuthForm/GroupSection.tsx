                ...
                <div className="flex items-center gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-border bg-white shadow-sm py-2.5 pl-10 pr-3 font-mono text-base tracking-[0.2em] outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20"
                    />
                  </div>
                  <motion.button
                    type="button"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full appearance-none rounded-xl border border-border bg-white shadow-sm py-2.5 pl-10 pr-3 text-base outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20"
                  >
