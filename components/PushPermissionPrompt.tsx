  ...
  return (
    <div className="flex items-center gap-3 border-b border-highlight/40 bg-highlight/15 px-4 py-3">
      ...
      <button
        ...
        className="rounded-full bg-gradient-to-r from-primary to-teal px-3 py-1 text-sm font-medium text-white shadow-sm shadow-primary/30 transition-transform active:scale-95"
      >
        Enable
      </button>
