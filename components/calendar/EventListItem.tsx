...
import { ChatText, DotsThreeVertical, ForkKnife, MapPin } from "@phosphor-icons/react";
    ...
    <div className="flex gap-3 rounded-2xl border border-border/60 bg-white p-4 shadow-sm">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-start justify-between gap-2">
          <p className="min-w-0 break-words font-medium text-primary">{event.title}</p>
          {canManage && (
            <button
              type="button"
        ...
        {(relatedTopics.length > 0 || potluck) && (
          <div className="mt-2 flex flex-wrap gap-2">
            ...
            {potluck && (
              ...
              >
                <ForkKnife size={12} /> {potluck.title} · {potluck.itemCount}{" "}
                {potluck.itemCount === 1 ? "item" : "items"}
